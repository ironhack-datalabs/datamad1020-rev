...
print("No, we are not able to add a and b because they have different shapes: ValueError: operands could not be broadcast together with shapes (2,3,5) (5,2,3)")
